...
select 고객아이디, 제품명, 단가 from 고객 c, 제품 o, 주문 p where c.고객이름='고명석' and c.고객아이디= p.주문고객 and o.제품번호 = p.주문제품;

-- 내추럴 조인으로 나이가 30세 이상인 고객이 주문한 제품의 주문제품과 주문일자를 검색하시오.
select 주문제품, 주문일자 from 고객, 제품, 주문 where 나이>=30 and 고객아이디 = 주문고객;

-- 내부조인 (InnerJoin)
-- 내부조인으로 나이가 30세 이상인 고객이 주문한 제품의 주문제품과 주문일자를 검색하시오.
select 주문제품, 주문일자 from 고객 inner join 주문 on 고객아이디=주문고객 where 나이>=30;

-- 외부조인 (Left OuterJoin / Right OuterJoin)
-- 왼쪽 외부조인으로 주문하지 않은 고객도 포함해서 고객이름과 주문제품, 주문일자를 검색하시오.
select 고객이름, 주문제품, 주문일자 from 고객 left outer join 주문 on 고객아이디=주문고객; 

-- 오른쪽 외부조인으로 주문하지 않은 고객도 포함해서 고객이름과 주문제품, 주문일자를 검색하시오.
...
select 고객아이디, 나이, 적립금, 제품명, 단가 from 고객, 제품 , 주문  where 고객아이디 = 주문고객 and 제품번호 = 주문제품 and 주문고객 in (
                                                                                                                               select 고객아이디 from 고객 where 고객이름 like '김%'
                                                                                                                               );
-- 다중행 결과에 사용하는 Not In 연산자
-- banana 고객이 주문하지 않은 제품의 제품명, 제조업체를 검색하시오.
select 제품명, 제조업체 from 제품 where 제품번호 not in (
                                                     select 주문제품 from 주문 where 주문고객 = 'banana'
                                                     );

-- 다중행 결과에 사용하는 ALL 연산자
-- 대한식품이 제조한 모든 제품의 단가보다 더 비싼 제품의 제품명, 단가, 제조업체를 검색하시오. 
...
select * from 주문 where 주문일자 = '2022-03-15';
select 고객이름 from 고객 where 고객아이디 = (
                                            select 주문고객 from 주문 where 주문일자 = '2022-03-15'
                                           );
select 고객이름, 주문일자 from 고객,주문 where 고객아이디=주문고객 and 주문일자 = '2022-03-15';

-- 다중행 결과에 사용하는 Exists / Not Exists 연산자
-- 2022년 1월 1일에 제품을 주문한 고객의 고객이름을 검색하시오. (여러명인 경우)
select 고객이름 from 고객 where exists (
                                       select 주문고객 from 주문 where 주문일자= '2022-01-01' and 주문고객=고객아이디
                                        );
    
-- 2022년 1월 1일에 제품을 주문하지 않은 고객의 고객이름을 검색하시오. (여러명인 경우)
