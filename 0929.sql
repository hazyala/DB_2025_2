...
-- 속성 (칼럼, 필드) 리스트를 생략하여 추가
insert into  고객 values('grapes','강포도',NULL,'vip','의사',1500);
-- 속성 (칼럼, 필드) 리스트를 작성하여 추가
insert into 고객 (고객아이디, 고객이름, 직업, 등급, 적립금) values('grapes','강포도',NULL,'vip','의사',1500);
...
-- View 생성 방법
-- 등급이 vip 인 고객의 고객아이디, 고객이름, 나이, 등급으로 구성된 view 를 우수고객이라는 이름으로 생성하시오.
